...
<body>
            ...
            <div class="guidebox">
                <div class="leftguide">
                    <div class="guideboximg">
                        <!-- <img class="guideimg" src="images/figma2.png" alt="Guide images"> -->
                        <img class="guideimg" id="gi1" src="images/resumeTemplateimg/resume1.png" alt="Guide images">
                    </div>
                </div>
                    ...
                    <div class="gcontent" onmouseover="changeimg()">
                        <div class="numreldiv">
                            <div class="numanime">
                                ...
                                <!-- if you get the spare time then you can make the wave animation -->
                                <!-- <div class="guidewave"></div> -->
                            </div>
                        </div>
    ...
    <section>
        <div class="mainslide">
            ...
            <!-- <div class="t" style="border-color: #0040FF; width:200px; height:200px; z-index: 1; position: relative; display: block;"></div> -->
